    ...
    <section className="section__news-article">
      <div className="container container__news-article">
        ...
        <p className="news__p">
          ...
          Васильевич 23 сентября 2021&nbsp;г. в&nbsp;Ставропольском Краевом
        ...
        <div className="news__main-flex">
          ...
          <div className="news__help-flex">
            <p className="news__p">
              Врач сердечно-сосудистый хирург Центра кардиохирургии&nbsp;КВМТ
              им.&nbsp; Н.И.Пирогова СПбГУ (г.&nbsp;Санкт-Петербург) кандидат
              медицинских наук{" "}
