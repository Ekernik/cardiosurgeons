...
import img_doctor from '../../assets/images/doctors/doctor_Zubarev.jpg';
      ...
      <section className="section__doctor container">
        <div className="doctor__flex">
          <div className="doctor__card">
            <h1 className="doctor__name">Зубарев Евгений Игоревич</h1>
            <img
...
"
          ...
          <div className="doctor__info">
            ...
            <section className="doctor__theme-section">
              ...
              <p className="doctor__text">— синдром WPW</p>
              <p className="doctor__text">— предсердная тахикардия</p>
              <p className="doctor__text">— ПРАВУТ</p>
              <p className="doctor__text">
                — пароксизмальная/персистирующая фибрилляция предсердий
              </p>
              <p className="doctor__text">— трепетание предсердий</p>
              <p className="doctor__text">— инцизионные тахикардии</p>
              <p className="doctor__text">
            ...
            <section className="doctor__theme-section">
              ...
              <p className="doctor__text">
                ...
                Отделение рентгенохирургического лечения сложных нарушений ритма
            ...
            <section className="doctor__theme-section">
              ...
              <p className="doctor__text">
                ...
                «сердечно-сосудистая хирургия». Федеральный Центр Сердца, Крови
                и Эндокринологии им. В. А. Алмазова. Кандидат медицинских
                наук,тема диссертационного исследования: «Оптимизация
                интервенционного лечения больных с хронической сердечной
                недостаточностью».
              </p>
              <p className="doctor__text">
            ...
            <section className="doctor__theme-section">
              ...
              <p className="doctor__text">
                ...
                Бакулева. Российская школа-семинар по клинической
            ...
            <section className="doctor__theme-section">
              ...
              <p className="doctor__text">
                ...
                «Медицина XXI века – интеграция знаний на перекрестке наук» 7-9
                июня 2018, Санкт-Петербург.
              </p>
              <p className="doctor__text">
              ...
              <p className="doctor__text">
                ...
                Санкт-Петербурга» и 42-е заседание регионального отделения ВНОА
                и Школы практической аритмологии, 1 Апреля 2017,
                Санкт-Петербург.
              </p>
              <p className="doctor__text">
                — VI Санкт-Петербургская школа аритмологии, 11-13 сентября 2017:
                доклад «Трепетание предсердий и критерии успешной аблации»;
                доклад «Ротационная ангиография в аритмологии».
              </p>
              <p className="doctor__text">
              ...
              <p className="doctor__text">
                ...
                инновациям в медицине», посвященная 35-летию ФГБУ «СЗФМИЦ им. В.
                А. Алмазова» Минздрава России, 28-30 октября 2015,
                Санкт-Петербург.
              </p>
              <p className="doctor__text">
              ...
              <p className="doctor__text">
                ...
                predict outcome in patients who underwent cardiac
              ...
              <p className="doctor__text">
                ...
                отдаленные результаты кардиоресинхронизирующей терапии?»; доклад
                «3D венография при имплантации CRT».
              </p>
              <p className="doctor__text">
              ...
              <p className="doctor__text">
                ...
                Angiography Followed by 3-D Reconstruction of Coronary Sinus in
