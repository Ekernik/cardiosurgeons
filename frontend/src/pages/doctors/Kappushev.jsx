...
import img_doctor from '../../assets/images/doctors/doctor_Kappushev.jpg';
      ...
      <section className="section__doctor container">
        <div className="doctor__flex">
          <div className="doctor__card">
            <h1 className="doctor__name">Каппушев Руслан Юсуфович</h1>
            <img
...
"
            ...
            <div className="marked-container doctor__about">
              <h2 className="doctor__position">
                Врач сердечно-сосудистый хирург 1-ой квалификационной категории,
                врач по рентгенэндоваскуляным диагностике и лечению 1-ой
                квалификационной категории Центра кардиохирургии и
          ...
          <div className="doctor__info">
            <section className="doctor__theme-section">
              ...
              <p className="doctor__text">
                ...
                рентгенхирургических методов диагностики и лечения ГБУЗ АО АМОКБ
                г. Астрахань.
              </p>
              <p className="doctor__text">
            ...
            <section className="doctor__theme-section">
              ...
              <p className="doctor__text">
                ...
                Специализация - "рентегнэдоваскулярная диагностика и лечение" на
                базе ФГБУ «Новосибирский Научно Исследовательский Институт
                Патологии Кровообращения им. Е. Н. Мешалкина»
              ...
              <p className="doctor__text">
                ...
                Новосибирский Государственный Медицинский Университет. Факультет
                лечебное дело. Квалификация: врач. Специальность: лечебное дело.
              </p>
            </section>
            <section className="doctor__theme-section">
              ...
              <p className="doctor__text">
                — Сердечно-сосудистая хирургия. Годен до 03.10.2023. Выдан: ГБОУ
