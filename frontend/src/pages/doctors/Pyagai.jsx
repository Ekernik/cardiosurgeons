...
import img_doctor from '../../assets/images/doctors/doctor_Pyagai.jpg';
      ...
      <section className="section__doctor container">
        <div className="doctor__flex">
          <div className="doctor__card">
            <h1 className="doctor__name">Пягай Виктор Александрович</h1>
            <img
          ...
          <div className="doctor__info">
            ...
            <section className="doctor__theme-section">
              ...
              <p className="doctor__text">
                ...
                «НМИЦ им. В. А. Алмазова» Министерства здравоохранения
