  ...
  return (
    <section className="section__about-op-03 container">
      ...
      <p className="article__p">
        ...
        обхода места сужения (стеноза) сосуда с помощью шунтов.
      </p>
      <p className="article__p">
        Операция аортокоронарного шунтирования относится к хирургическим методам
        коррекции ишемической болезни (ИБС), целью которой является прямое
        увеличение кровотока к мышечным клеткам сердца - миокарду.
      </p>
      <p className="article__p">
        ...
        <a
          href="https://heartteamspb.com/diagnostics/coronarographia"
          className="article__link"
        >
          коронарография
        </a>
        , по результатам которой хирург оценивает степень сужения коронарных
      ...
      <p className="article__p">
        ...
        Подготовка к операции коронарного шунтирования сосудов сердца обычно
        занимает от 1 до 3 дней (исключая экстренные показания).
      </p>
      <p className="article__p">
      ...
      <p className="article__p">
        ...
        кровообращения и кардиоплегического раствора. После успешно проведенной
        операции пациент переводится в отделение реанимации, где будет
        обеспечено постоянное наблюдение с помощью специального оборудования. На
        следующий день, в случае стабильного состояния, осуществляется перевод
        на профильное кардиохирургическое отделение, где постепенно происходит
