      ...
      <div className='App'>
        ...
        <article className='mt container'>
          ...
          <p className='article__p'>
            ...
            КТ в{' '}
            <Link href='/'>
              <a className='article__link'>кардиохирургии</a>
            </Link>
            , то прежде всего стоит отметить высокую информативность данного
            метода. Данный метод позволяет хирургам оценить размеры камер сердца
            и сосудов, наличие{' '}
            <Link href='/diagnostics/ateroskleros'>
              <a className='article__link'>атеросклеротического процесса</a>
            </Link>
