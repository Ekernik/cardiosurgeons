      ...
      <div className='App'>
        <main>
          ...
          <article className='container mt'>
            ...
            <p className='article__p'>
              При расслоении аорты "золотым стандартом" обследования считается
            ...
            <ol className='article__ol'>
              <li className='article__li'>
                ...
                <p className='article__p'>
                  ...
                  разрыва, закрывая "входные ворота" расслоения. Процедуры
                  ...
                  необходимо, чтобы аорта имела определённую анатомию, что
                  является ограничением данного метода.
                </p>
              </li>
              <li className='article__li'>
                <p className='article__p'>
