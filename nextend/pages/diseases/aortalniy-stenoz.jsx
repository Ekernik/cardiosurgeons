        ...
        <main>
          ...
          <article className='container mt'>
            ...
            <p className='article__p'>
              Аортальный стеноз — это заболевание, являющееся как врожденным,
              так и приобретенным{' '}
              <Link href='/diseases/poroki-serdca' text='пороком сердца' />. При
              этом створки аортального клапана, расположенного на выходе из
              левого желудочка в аорту, срастаются между собой. В результате
              подвижность створок при открывании и закрывании резко
              ограничивается, препятствуя нормальному движению крови через
              клапан. Как следствие, наступает застой крови в левом желудочке и
              недостаточное поступление крови ко всем органам.
            </p>
            ...
            <p className='article__p'>
              ...
              врожденном сужении устья аорты или аномалии развития -
              двустворчатом аортальном клапане. Врожденный порок аортального
              клапана обычно проявляется в возрасте до 30 лет; приобретенный – в
              более старшем возрасте (обычно после 60 лет).
            </p>
            <h2 className='article__p text-center'>
            ...
            <p className='article__p'>
              ...
              методов диагностики аортального стеноза является эхокардиография.
              Этот метод ультразвуковой диагностики позволяет не только выявить
              наличие данного заболевания, но и определить степень его
              выраженности, степень застоя крови в лёгких (легочную
              гипертензию), а также оценить операбельность.
            </p>
            <h2 className='article__p text-center'>
            ...
            <p className='article__p'>
              ...
              аортальный стеноз может быстро привести к инвалидизации пациента.
              В далеко зашедших случаях аортальный стеноз осложняется инфарктом
