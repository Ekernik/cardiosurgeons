    ...
    <>
      ...
      <article className='container'>
        ...
        <p>
          ...
          возникающее в эктопическом очаге под влиянием патологического
          импульса. В зависимости от места возникновения патологического
          импульса экстрасистолия классифицируется на предсердную и
          желудочковую.
        </p>
        <h2>Причины экстрасистолии</h2>
        <p>
        ...
        <h2>Симптомы и проявления экстрасистолии</h2>
        <p>
        ...
        <h2>Диагностика экстрасистолии</h2>
        <p>
        ...
        <p>
          Выбор метода лечения основывается на клинической картине заболевания,
          данных инструментальных исследований и действующих рекомендаций. Как
          правило, лечение экстрасистолии начинается с медикаментозной
          антиаритмической терапии.
        </p>
        <p>
          Контроль эффективности лечения выполняется путем повторного суточного
          мониторирования ЭКГ.
        </p>
        <p>
          При неэффективности терапии, появлении серьезных побочных эффектов или
          при невозможности длительного приема таблеток (например, при
          планировании беременности) может быть выполнена радиочастотная абляция
          - устранение патологического очага радиочастотной энергией, подаваемой
          с помощью катетера. РЧА во многих случаях позволяет избавиться от
          аритмии навсегда без необходимости последующего длительного приема
          препаратов.
        </p>
        <h2>Выводы</h2>
        <p>
