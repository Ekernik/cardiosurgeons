      ...
      <article className='container'>
        ...
        <div className='flex'>
          <div className={local_styles.text_content}>
            <h3>Прием сердечно-сосудистого хирурга в городе Липецкe</h3>
            <p>
              23 августа 2022 года в городе Липецк состоится выездной прием
              кардиохирурга нашей клиники Сорокина Андрея Александровича.
              Приглашаем на консультацию пациентов с сердечно-сосудистыми
              заболеваниями для отбора на БЕСПЛАТНОЕ лечение в Санкт-Петербурге
              (по ОМС или федеральным квотам).
            </p>
            <p>
