...
// Череповец - 19 мая 2022 - 2 врача - Зубарев и Асадуллин
const Announcement: NextPage = () => {
  const doctor_1 = doctors[8];
  const doctor_2 = doctors[11];
  const addressOfVisit = 'г. Череповец, ул. Социалистическая, д. 50';
  const dateOfNews = '16 мая 2022';
  ...
  const SEODetails = {
    title: `Прием кардиохирурга в городе Череповец`,
    description: `Кардиохирурги из Петербурга ведут прием в городе Череповец. Записывайтесь на консультацию и дальнейшее лечение по квотам и ОМС.`,
    pageLink:
      'https://heartteamspb.com/news/priem-v-gorode-cherepovets-19.05.2022',
    type: 'article',
  };
  ...
  return (
    <>
      ...
      <Header />
      <Greetings
        header={{ title: `19 мая`, pretitle: city }}
        buttonText='Записаться на консультацию'
      />
      <article className='container'>
        <h6 className={local_styles.date}>Новость от {dateOfNews} года</h6>
        <h3>
          19 мая – {city} – приглашаем пациентов на&nbsp;прием
        ...
        <div className={local_styles.main_flex}>
          <div className={local_styles.place_info}>
            <p>
              Прием будет проводиться: <strong>19 мая 2022 г.</strong>
            </p>
            <p>
              По адресу:{' '}
              <a
