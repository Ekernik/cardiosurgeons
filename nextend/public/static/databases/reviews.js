const REVIEWS = [
  ...
  },
  {
    ...
    doctors: ['zubarev'],
    message: [
      'Я - Вааг Ирма Фридрихвна хочу сказать огромное спасибо Зубареву Евгению Игоревичу за его талант оперировать больных. Мне он тоже сделал 07.12.21г (сделал мне) операцию и тем самым продлил мне жизнь, как говорят, на 10 лет. Я просто счастлива. Мне сейчас 73 года + 10 лет.',
    ],
    date: '',
    readmore: true,
  },
