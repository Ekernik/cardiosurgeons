    ...
    <div>
      <p className="article__p">
        ...
        <Link href="/team/doctor_vasilev">
          <a className="article__link">Васильеву&nbsp;А.С.</a>
        </Link>
        ,{' '}
        <Link href="/team/doctor_sorokin">
          <a className="article__link">Сорокину&nbsp;А.Л.</a>
        </Link>
        , всем операционным медсестрам, анестезиологам, заведующему{' '}
        <Link href="/team/doctor_stolyarov">
          <a className="article__link">Столярову М.С.</a>
        </Link>
        ...
        <Link href="/team/doctor_stolyarov">
          <a className="article__link">Котовой А.С.</a>
        </Link>{' '}
        и&nbsp;
        <Link href="/team/doctor_stolyarov">
          <a className="article__link">Поваренкиной В.В.</a>
        </Link>
      </p>
      <p className="article__p">
